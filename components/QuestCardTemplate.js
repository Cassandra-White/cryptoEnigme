...
const QuestCard = (props) => (
  ...
  <Card>
    <Image src={props.questPicture ? props.questPicture : 'http://gallery.tranchesdunet.com/galerie-sf-villes/1920x1080-Dizorb-CityScape-HD-Wallpaper.jpg'} wrapped ui={false} />
    <Card.Content>
      <Card.Header>{props.questTitle}</Card.Header>
      <Card.Meta>
        <span className='date'>Contrat : {props.manager ? props.manager : ' addresse du contract'}</span>
      </Card.Meta>
      <Card.Description>
