...
class QuestOfficialNew extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      const data = await questFactory.methods
        .createQuestCommunity(
          ...
          <Grid.Row>
              ...
              <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
                <Form.Field>
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ questTitle: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ questPicture: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ questDescription: event.target.value })
                    }
                  />
            ...
            <Grid.Column width={8}>
              <QuestCardTemplate
                ...
                questPrice={this.state.questPrice}
                questDescription={this.state.questDescription}
                questPicture={this.state.questPicture}
              />
            </Grid.Column>
          </Grid.Row>
        </Grid>
