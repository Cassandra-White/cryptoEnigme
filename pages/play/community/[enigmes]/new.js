...
class EnigmesIndexNew extends Component {
  ...
  onSubmit = async (event) => {
    ...
    try {
      ...
      const data = await Quest(this.props.address)
        .methods.createEnigme(
              ...
              <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
                <Form.Field>
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ titleEnigme: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ contentEnigme: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ reponseEnigme: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ clueEnigme1: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ clueEnigme2: event.target.value })
                    }
                  />
                  ...
                  <Input
                    ...
                    onChange={(event) =>
                      this.setState({ clueEnigme3: event.target.value })
                    }
                  />
                </Form.Field>
                <Message
